...
export default class Doc extends Object {
  docNode;
  updates;
  static SvgElementMixed(tagname, nodes){
    const p=Doc.MixedNodes(nodes);
  ...
  static ConcatMixed(elts){
    return Doc.Concat(map(Doc.ToMixedDoc, elts));
  }
      ...
      while(e.MoveNext())
        {
          ...
          else children.push(Doc.ToMixedDoc(n));
        }
    }
    finally {
      const _1=e;
  ...
  static ToMixedDoc(o){
    return o instanceof Doc?o:typeof o=="string"?Doc.TextNode(o):o instanceof Element?Doc.StaticProxy(o):typeof o=="function"?Doc.EmbedView(Map(Doc.ToMixedDoc, o)):o instanceof Var?Doc.EmbedView(Map(Doc.ToMixedDoc, o.View)):Equals(o, null)?Doc.Empty:Doc.TextNode(String(o));
  }
  ...
  static Radio(attrs, value, var_1){
    ...
    return Elt.New(el, Attr.Concat(append_1(ofArray([_____("type", "radio"), _____("name", var_1.Id), valAttr]), ofSeq(attrs))), Doc.Empty);
  }
  static LinkView(caption, attrs, view, action){
    ...
    return Elt.New(globalThis.document.createElement("a"), attrs_1, Doc.TextNode(caption));
  }
  static Link(caption, attrs, action){
    const x=Attr.Concat(attrs);
    const attrs_1=AppendTree(Attr.Create("href", "#"), x);
    return Elt.New(Doc.Clickable("a", action), attrs_1, Doc.TextNode(caption));
  }
  static ButtonView(caption, attrs, view, action){
    const attrs_1=Attr.Concat(append([HandlerView("click", view, () =>() => action)], attrs));
    return Elt.New(globalThis.document.createElement("button"), attrs_1, Doc.TextNode(caption));
  }
  ...
  static CheckBoxGroup(attrs, item, chk){
    ...
    return Doc.CheckBox(attrs, _1);
  }
  static CheckBox(attrs, chk){
    return Doc.InputInternal("input", () => append(attrs, [Attr.Create("type", "checkbox"), Checked(chk)]));
  }
  static SelectDynOptional(attrs, noneText, show, vOptions, current){
    return Doc.SelectDyn(attrs, (a) => a!=null&&a.$==1?show(a.$0):noneText, Map((options) => FSharpList.Cons(null, map_1((V) => Some(V), options)), vOptions), current);
  }
  static SelectOptional(attrs, noneText, show, options, current){
    return Doc.Select(attrs, (a) => a!=null&&a.$==1?show(a.$0):noneText, FSharpList.Cons(null, map_1((V) => Some(V), options)), current);
  }
  static SelectMultiple(attrs, show, options, current){
    return Doc.SelectMultipleImpl(attrs, (rOptions) => {
      rOptions[0]=options;
      return Doc.Concat(mapi_1((_1, _2) => Doc.Element("option", ofArray([Attr.Create("value", String(_1))]), ofArray([Doc.TextNode(show(_2))])), options));
    }, current);
  }
  static SelectMultipleDyn(attrs, show, vOptions, current){
    return Doc.SelectMultipleImpl(attrs, (options) => Doc.Convert((_1) => Doc.Element("option", ofArray([Attr.Create("value", String(_1[0]))]), ofArray([Doc.TextNode(show(_1[1]))])), Map((l) => {
      options[0]=l;
      return mapi((_1, _2) =>[_1, _2], l);
    }, vOptions)), current);
  }
  static Select(attrs, show, options, current){
    return Doc.SelectImpl(attrs, show, (rOptions) => {
      rOptions[0]=options;
      return Doc.Concat(mapi_1((_1, _2) => Doc.Element("option", ofArray([Attr.Create("value", String(_1))]), ofArray([Doc.TextNode(show(_2))])), options));
    }, current);
  }
  static SelectDyn(attrs, show, vOptions, current){
    return Doc.SelectImpl(attrs, show, (options) => Doc.Convert((_1) => Doc.Element("option", ofArray([Attr.Create("value", String(_1[0]))]), ofArray([Doc.TextNode(show(_1[1]))])), Map((l) => {
      options[0]=l;
      return mapi((_1, _2) =>[_1, _2], l);
    }, vOptions)), current);
  }
  ...
  static InputArea(attr, var_1){
    return Doc.InputInternal("textarea", () => append(attr, [Value(var_1)]));
  }
  static RangeInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [IntValueUnchecked(var_1), Attr.Create("type", "range")]));
  }
  static WeekInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1), Attr.Create("type", "week")]));
  }
  static UrlInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1), Attr.Create("type", "url")]));
  }
  static TimeInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1), Attr.Create("type", "time")]));
  }
  static TelInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1), Attr.Create("type", "tel")]));
  }
  static SearchInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1), Attr.Create("type", "search")]));
  }
  static MonthInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1), Attr.Create("type", "month")]));
  }
  static FileInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [FileValue(var_1), Attr.Create("type", "file")]));
  }
  static EmailInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1), Attr.Create("type", "email")]));
  }
  static DateTimeLocalInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [DateTimeValue(var_1), Attr.Create("type", "datetime-local")]));
  }
  static DateInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1), Attr.Create("type", "date")]));
  }
  static ColorInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1), Attr.Create("type", "color")]));
  }
  static FloatInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [FloatValue(var_1), Attr.Create("type", "number")]));
  }
  static FloatInputUnchecked(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [var_1.Get()===0?Attr.Create("value", "0"):EmptyAttr(), FloatValueUnchecked(var_1), Attr.Create("type", "number")]));
  }
  static IntInput(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [IntValue(var_1), Attr.Create("type", "number")]));
  }
  static IntInputUnchecked(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [var_1.Get()===0?Attr.Create("value", "0"):EmptyAttr(), IntValueUnchecked(var_1), Attr.Create("type", "number")]));
  }
  static PasswordBox(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1), Attr.Create("type", "password")]));
  }
  static Input(attr, var_1){
    return Doc.InputInternal("input", () => append(attr, [Value(var_1)]));
  }
  static InputInternal(elemTy, attr){
    const el=globalThis.document.createElement(elemTy);
    return Elt.New(el, Attr.Concat(attr(el)), Doc.Empty);
  }
  static ConvertSeqVarBy(key, render, var_1){
    return Doc.Flatten(Var_1.MapLens(key, render, var_1));
  }
  ...
  static ConvertSeq(render, view){
    return Doc.Flatten(MapSeqCachedView(render, view));
  }
  static ConvertBy(key, render, view){
    return Doc.Flatten(MapSeqCachedBy(key, render, view));
  }
  ...
  static Async(a){
    return Doc.EmbedView(MapAsync((x) => x, Const(a)));
  }
  ...
  static StaticProxy(el){
    return Elt.New(el, EmptyAttr(), Doc.Empty);
  }
  static TextNode(v){
