...
let _c=Lazy((_i) => class $StartupCode_Site {
  ...
  static {
    ...
    this.buttonS="background:#2d3a8c;color:white;padding:12px 24px;border:none;border-radius:8px;font-size:1.1rem;font-weight:bold;cursor:pointer;margin-top:16px;transition:background 0.3s;";
    this.messageS="margin-top:16px;font-size:1.2rem;font-weight:bold;min-height:24px;";
  }
});
export default _c;
